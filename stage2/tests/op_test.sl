...
fn i32 arith_add_i32_i32(arena::Arena* a, const u8[]m) {
...
fn i32 arith_all_ops_i32(arena::Arena* a, const u8[]m) {
...
fn i32 arith_mixed_sign_null(arena::Arena* a, const u8[]m) {
...
fn i32 arith_f32_f32(arena::Arena* a, const u8[]m) {
...
fn i32 arith_f32_f64_widens(arena::Arena* a, const u8[]m) {
...
fn i32 arith_ptr_minus_int_and_ptr(arena::Arena* a, const u8[]m) {
    types::typer_init(a, 16);
    types::Ty* p = types::intern_pointer(types::prim_i32(), false);
...
fn i32 eq_widen_is_bool(arena::Arena* a, const u8[]m) {
    types::Ty* r = op::binop_result_type(token::TokenKind::BangEq, types::prim_i16(), types::prim_i32());
    if(!testing::expect_eq((void*)r, (void*)types::prim_bool(), m)) { return -1; }
    return 0;
}

fn i32 eq_ptr_is_bool(arena::Arena* a, const u8[]m) {
    types::typer_init(a, 16);
    types::Ty* p = types::intern_pointer(types::prim_i32(), false);
...
fn i32 eq_null_ptr_is_bool(arena::Arena* a, const u8[]m) {
    types::typer_init(a, 16);
    types::Ty* p = types::intern_pointer(types::prim_i32(), false);
...
fn i32 eq_fnptr_and_null(arena::Arena* a, const u8[]m) {
    types::typer_init(a, 16);
...
fn i32 logic_int_truthy(arena::Arena* a, const u8[]m) {
    types::Ty* r = op::binop_result_type(token::TokenKind::AmpAmp, types::prim_i32(), types::prim_bool());
    if(!testing::expect_eq((void*)r, (void*)types::prim_bool(), m)) { return -1; }
    return 0;
}

fn i32 logic_ptr_truthy(arena::Arena* a, const u8[]m) {
    types::Ty* p = types::intern_pointer(types::prim_i32(), false);
...
fn i32 deref_ptr(arena::Arena* a, const u8[]m) {
    types::typer_init(a, 16);
    types::Ty* p = types::intern_pointer(types::prim_i32(), false);
...
fn i32 deref_non_ptr_null(arena::Arena* a, const u8[]m) {
    types::Ty* r = op::unaryop_result_type(token::TokenKind::Star, types::prim_i32());
    if(!testing::expect_eq((void*)r, null, m)) { return -1; }
    return 0;
}

fn i32 unary_null_operand(arena::Arena* a, const u8[]m) {
...
fn i32 main() {
    ...
    const u8[] arith = "Op Arithmetic Tests";
    ...
    const u8[] bits = "Op Bitwise/Shift Tests";
    ...
    const u8[] cmp = "Op Comparison Tests";
    ...
    const u8[] logic = "Op Logical Tests";
