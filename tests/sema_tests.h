...
void test_UndeclaredVariable_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:39:Error: undeclared identifier var_b.\n";
...
void test_ConstNoInit_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:27:Error: const variable must have an initializer.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_AssignmentToConst_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:38:Error: cannot assign a value to a const variable i.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_AssignmentToRValue_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:36:Error: cannot assign a value to a literal.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_VariableRedeclaration_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:20:Error: variable var_a already declared in this scope.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_FnRedeclaration_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:28:Error: function foo already declared in this scope.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructRedeclaration_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:24:Error: struct redeclaration.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructLiteralInitUnknownField_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:37:Error: cannot find a field with name 'second' in the definition of struct 'Str'.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructLiteralInitMoreInitsThanFields_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:25:Error: struct 'Str' has 0 fields, check initialization.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructLiteralPositionalWrongType_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:30:Error: assignment type mismatch: cannot implicitly convert f32 to i32.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructLiteralPositionalSecondFieldWrongType_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:40:Error: assignment type mismatch: cannot implicitly convert f32 to i32.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructLiteralDesignatedWrongType_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:40:Error: assignment type mismatch: cannot implicitly convert i32 to f32.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructLiteralBoolLitIntoIntField_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:31:Error: assignment type mismatch: cannot implicitly convert bool to i32.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructLiteralIntLitIntoBoolField_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:29:Error: assignment type mismatch: cannot implicitly convert i32 to bool.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructLiteralCharLitIntoIntField_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:27:Error: cannot initialize field 'a' of type i32 with a char literal.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructLiteralIdentWrongType_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:61:Error: type mismatch initializing field 'a': cannot implicitly convert f32 to i32.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructLiteralNestedInnerWrongType_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:65:Error: assignment type mismatch: cannot implicitly convert f32 to i32.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructLiteralDesignatedUnknownFieldBeforeTypeCheck_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:27:Error: cannot find a field with name 'b' in the definition of struct 'S'.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_NullAssignToIntFails_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:30:Error: assignment type mismatch: cannot implicitly convert void* to i32.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_NullAssignToFloatFails_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:30:Error: assignment type mismatch: cannot implicitly convert void* to f32.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_NullReturnFromIntFn_sema(void) {
	TEST_SETUP_SINGLE("fn i32 foo() { return null; }");
	const char *expected = "parser_tests.sl:1:21:Error: cannot implicitly convert from void* to i32.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_NullInStructFieldInitWrongType_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:31:Error: assignment type mismatch: cannot implicitly convert void* to i32.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_EnumRedeclaration_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:20:Error: enum redeclaration.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_StructFieldRedeclaration_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:25:Error: field redeclaration.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_EnumMemberRedeclaration_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:19:Error: enum member redeclaration.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_ParamRedeclaration_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:25:Error: parameter redeclaration: a.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_UndeclaredFunction_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:19:Error: undeclared identifier baz.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_ArgCountMismatch_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:21:Error: argument count mismatch.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_ArgTypeMismatch_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:21:Error: cannot implicitly convert from type f32 to type i32 in function call baz.\nparser_tests.sl:1:21:Error: cannot implicitly convert from type bool to type i32 in function call baz.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
...
void test_FuncCallAssignmentWrongType_sema(void) {
	...
	const char *expected = "parser_tests.sl:1:76:Error: assignment type mismatch: cannot implicitly convert i32 to f32.\n";
	TEST_ASSERT_EQUAL_STRING(expected, output);
	free(output);
}
