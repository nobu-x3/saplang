...
TEST_CASE("generic in struct", "[sema]") {
  SECTION("1-deep generic") {
    TEST_SETUP_MODULE_SINGLE("1-deep generic", R"(
struct<T> Generic {
    T value;
}
struct Specific {
  ...
  SECTION("2-deep generic") {
    TEST_SETUP_MODULE_SINGLE("2-deep generic", R"(
struct<T> Generic1 {
    T value;
}
struct<T> Generic2 {
...
struct Specific {
  ...
  SECTION("3-deep generic") {
    TEST_SETUP_MODULE_SINGLE("3-deep generic", R"(
struct<T> Generic1 {
    T value;
}
struct<T> Generic2 {
...
struct Specific {
  ...
  SECTION("2-deep 2-type generic") {
    TEST_SETUP_MODULE_SINGLE("2-deep 2-type generic", R"(
struct<T> Generic1 {
    T* value;
}
struct<T, K> Generic2 {
...
TEST_CASE("generic in function decl", "[sema]") {
  SECTION("1-deep generic fn") {
    TEST_SETUP_MODULE_SINGLE("1-deep_generic_fn", R"(
...
fn i32 main() {
    ...
    auto lines = break_by_line(output_buffer.str());
    auto lines_it = lines.begin() + 2;
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedGenericFunctionDecl: gen_fun<T>:void");
    CONTAINS_NEXT_REQUIRE(lines_it, "esolvedParamDecl: @(");
  ...
  SECTION("2-deep generic fn") {
    TEST_SETUP_MODULE_SINGLE("2-deep_generic_fn", R"(
fn void gen_fun<T>(T* generic_param) {
...
fn i32 main() {
    ...
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedParamDecl: @(");
    REQUIRE(lines_it->find(") generic_param:") != std::string::npos);
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedGenericFunctionDecl: gen_fun1<T>:void");
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedParamDecl: @(");
    REQUIRE(lines_it->find(") generic_param:") != std::string::npos);
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedFuncDecl: @(");
    REQUIRE(lines_it->find(") main:") != std::string::npos);
...
fn i32 main() {
    var TestType test = gen_fun<TestType>();
    return test.first;
}
)");
    REQUIRE(error_stream.str() == "");
    auto lines = break_by_line(output_buffer.str());
    auto lines_it = lines.begin() + 2;
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedGenericFunctionDecl: gen_fun<T>:T");
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedFuncDecl: @(");
    REQUIRE(lines_it->find(") main:") != std::string::npos);
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedBlock:");
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedDeclStmt:");
    ...
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedDeclStmt:");
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedVarDecl: @(");
    REQUIRE(lines_it->find(") generic_inst:TestType") != std::string::npos);
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedStructLiteralExpr: TestType");
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedFieldInitializer: first");
    CONTAINS_NEXT_REQUIRE(lines_it, "ResolvedNumberLiteral:");
    CONTAINS_NEXT_REQUIRE(lines_it, "i32(69)");
