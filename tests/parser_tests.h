...
void test_FunctionOverloading(void) {
	...
	const char *expected = "StructDecl: S\n"
						   "  FieldDecl: i32 i\n"
						   "UnionDecl: TestUnion\n"
						   "  FieldDecl: i32 a\n"
						   "  FieldDecl: i64 b\n"
						   "EnumDecl with 1 member(s) - Str : enum i32:\n"
						   "  One : 0\n"
						   "FuncDecl: foo\n"
						   "  Params:\n"
						   "  Body:\n"
						   ...
						   "FuncDecl: foo\n"
						   "  Params:\n"
						   "    ParamDecl: main::TestUnion** p_p_s\n"
						   "  Body:\n"
						   "    Block with 1 statement(s):\n"
						   "      Function call with 1 args:\n"
						   "        Ident: foo\n"
